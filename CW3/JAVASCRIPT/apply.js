function anaf() {
    var eng = document.querySelector('#apply_eng');
    var sci = document.querySelector('#apply_sci');
    var is = document.querySelector('#apply_is');
    ...
    for (var i = 0; i < clicks.length; i++) {
        clicks[i].onclick = function () {
            for (var i = 0; i < clicks.length; i++) {
                clicks[i].setAttribute('style', 'background-color: rgb(180, 180, 180);;');
            }
